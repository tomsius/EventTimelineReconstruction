...
namespace EventTimelineReconstruction.UnitTests.Converters;

[TestClass]
public class IntegrityResultsConverterTests
{
    ...
    {
        // Arrange
        IntegrityResultsConverter integrityResultsConverter = new();

        // Act
        object result = integrityResultsConverter.Convert(values, null, null, null);
        object[] actualResult = (object[])result;

        // Assert
        Assert.IsFalse(Object.ReferenceEquals(values, actualResult));
    ...
    public void ConvertBack_ShouldReturnEmptyArray_WhenAnyObjectIsGiven(object objectValue)
    {
        ...
        // Act
        object[] result = integrityResultsConverter.ConvertBack(objectValue, null, null, null);
