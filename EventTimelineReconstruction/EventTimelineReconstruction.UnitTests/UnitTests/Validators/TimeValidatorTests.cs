...
namespace EventTimelineReconstruction.UnitTests.Validators;
...
public class TimeValidatorTests
{
    ...
    public void AreDatesValid_ShouldReturnTrue_WhenDateAreInOrder()
    {
        ...
        DateTime from = new DateTime(1998, 10, 14, 11, 45, 25);
        DateTime to = new DateTime(2022, 5, 9, 23, 11, 58);
    ...
    public void AreDatesValid_ShouldReturnFalse_WhenDateAreOutOfOrder()
    {
        // Arrange
        TimeValidator timeValidator = new();
        DateTime from = new DateTime(2022, 5, 9, 23, 11, 58);
        DateTime to = new DateTime(1998, 10, 14, 11, 45, 25);
