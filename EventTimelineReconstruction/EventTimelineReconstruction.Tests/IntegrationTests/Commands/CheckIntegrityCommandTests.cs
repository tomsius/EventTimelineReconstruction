...
public class CheckIntegrityCommandTests
{
    ...
    public async Task Execute_ShouldShowFileOKAndEventsOKTextBlocks_WhenHashValuesAndEventsInStoreAreTheSame()
    {
        ...
        { 
            new(new EventModel(new DateOnly(1970, 1, 1), new TimeOnly(0, 0, 0), TimeZoneInfo.Utc, "....", "WEBHIST", "MSIE Cache File URL record", "Expiration Time", "-" , "PC1-5DFC89FB1E0", "Location: Visited: PC1@about:Home", "Location: Visited: PC1@about:Home Number of hits: 2 Cached file size: 0", 2, "TSK:/Documents and Settings/PC1/Local Settings/History/History.IE5/index.dat", "10536", "-", "msiecf", new Dictionary<string, string>() { { "cache_directory_index", "-2" }, { "recovered", "False" }, { "sha256_hash", "243645de118fab85ae3e5f4f820ee50717ddf478f17f7a678c88aa5d437a7e70" } })),
