...
public class HighLevelArtefactsAbstractorTests
{
    ...
    public HighLevelArtefactsAbstractorTests()
    {
        ...
        _highLevelArtefactsAbstractorUtils.Setup(u => u.GetDescriptionFromRegSource(_events[14].SourceType, _events[14].Description)).Returns("");
        ...
        _highLevelArtefactsAbstractorUtils.Setup(u => u.IsFileDuplicateOfLnk(_events, 35, _events[36])).Returns(false);
        _highLevelArtefactsAbstractorUtils.Setup(u => u.GetFileCountInRowAtSameMinute(_events, 36)).Returns(37);
        _highLevelArtefactsAbstractorUtils.Setup(u => u.GetFilename(_events[36].Description)).Returns("testas36.txt");
        _lowLevelEventsAbstractorUtils.Setup(u => u.GetExtraTillSha256(_events[36].Extra)).Returns("something36: somehing36");
        _highLevelArtefactsAbstractorUtils.Setup(u => u.GetValidFileEventIndices(_events, 36, It.IsAny<int>())).Returns(new List<int>() { 36 });
    }
    ...
    private List<EventViewModel> GetStoredEvents()
    {
        return new List<EventViewModel>()
        {
            ...
            new EventViewModel(new EventModel(new DateOnly(2009, 1, 1), new TimeOnly(12, 0, 0), TimeZoneInfo.Utc, ".A..", "REG", "UNKNOWN : BagMRU", "Last Time Executed", "User", "Host", "Something16", "Something16", 2, "Something16", "13452", "-", "winreg/userassist", new Dictionary<string, string>() { { "something16", "something16" } }, "16")),
            new EventViewModel(new EventModel(new DateOnly(2010, 1, 1), new TimeOnly(12, 0, 0), TimeZoneInfo.Utc, ".A..", "REG", "UNKNOWN : Run Key", "Last Time Executed", "User", "Host", "UEME_RUNPATH:::{645FF040-5081-101B-9F08-00AA002F954A} Count: 1", "Something17", 2, "Something17", "13452", "-", "winreg/userassist", new Dictionary<string, string>() { { "something17", "something17" } }, "17")),
            new EventViewModel(new EventModel(new DateOnly(2010, 1, 1), new TimeOnly(12, 0, 0), TimeZoneInfo.Utc, ".A..", "REG", "UNKNOWN : Run Key", "Last Time Executed", "User", "Host", "UEME_RUNPATH:::{645FF040-5081-101B-9F08-00AA002F954C} Count: 1", "Something18", 2, "Something18", "13452", "-", "winreg/userassist", new Dictionary<string, string>() { { "something18", "something18" } }, "18")),
            ...
            new EventViewModel(new EventModel(new DateOnly(2018, 1, 1), new TimeOnly(12, 0, 0), TimeZoneInfo.Utc, "B...", "FILE", "NTFS Creation Time", "Creation Time", "User", "Host", "C:\\Users\\User\\testas36.txt", "C:\\Users\\User\\testas36.txt Type: file", 2, "TSK:\\Users\\User\\testas36.txt", "13452", "-", "filestat", new Dictionary<string, string>() { { "something36", "something36" } }, "36"))
        };
    }
    ...
    private List<HighLevelArtefactViewModel> GetExpectedEvents()
    {
        ...
        {
            new HighLevelArtefactViewModel() { Date = new DateOnly(2000, 1, 1), Time = new TimeOnly(12, 0, 0), Source = "FILE", Short = "testas0.txt", Reference = "0", Extra = "something0: somehing0", Macb = "B...", SourceType = "NTFS Creation Time" },
            ...
            new HighLevelArtefactViewModel() { Date = new DateOnly(2008, 1, 1), Time = new TimeOnly(12, 0, 0), Source = "REG", Short = "{645FF040-5081-101B-9F08-00AA002F954E}", Reference = "14", Extra = "something14: something14", Macb = ".A..", SourceType = "Registry Key: UserAssist", Description = "" },
            new HighLevelArtefactViewModel() { Date = new DateOnly(2010, 1, 1), Time = new TimeOnly(12, 0, 0), Source = "REG", Short = "{645FF040-5081-101B-9F08-00AA002F954A}", Reference = "17", Extra = "something17: something17", Macb = ".A..", SourceType = "UNKNOWN : Run Key", Description = "Something17" },
            ...
            new HighLevelArtefactViewModel() { Date = new DateOnly(2017, 1, 1), Time = new TimeOnly(12, 0, 0), Source = "FILE", Short = "testas34.txt", Reference = "34", Extra = "something34: somehing34", Macb = "B...", SourceType = "NTFS Creation Time" },
            new HighLevelArtefactViewModel() { Date = new DateOnly(2018, 1, 1), Time = new TimeOnly(12, 0, 0), Source = "FILE", Short = "testas36.txt", Reference = "36", Extra = "something36: somehing36", Macb = "B...", SourceType = "NTFS Creation Time" }
        };
    }
    ...
    public void FormHighLevelArtefacts_ShouldReturnOnlyPeSourceEvent_WhenMethodIsCalled()
    {
        ...
        List<HighLevelArtefactViewModel> expected = new()
        {
            new HighLevelArtefactViewModel() { Date = new DateOnly(2003, 1, 1), Time = new TimeOnly(12, 0, 0), Source = "FILE", Short = "testas-0.txt", Reference = "0", Extra = "something-0: somehing-0", Macb = "B...", SourceType = "NTFS Creation Time" },
